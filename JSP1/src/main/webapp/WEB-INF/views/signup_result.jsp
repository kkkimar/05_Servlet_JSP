...
<body>
	...
	<%-- 
		request 변수 == 전달 받은 HTTPServletRequest 객체 참조하는 변수
		...
		<%= %> 태그 : Expression(표현식)
									JSP에서 자바의 값을 HTML화면에 출력(표현)하는 태그
									(Java 값 -> HTML 코드로 변환)
	 --%>
	...
	<% 
		...
		String inputPwCheck = request.getParameter("inputIdCheck");
